#!/usr/bin/env python3
"""
Import Italian Fountains using Firebase Service Account
This script requires a service account key file from Firebase Console
"""
...
class ServiceAccountImporter:
    """Imports Italian fountains using Firebase service account"""
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description='Import Italian fountains using Firebase service account')
    ...
    try:
        ...
        importer = ServiceAccountImporter(str(key_file))
